<template>
  <footer class="bg-gradient-to-b from-gray-900 to-black pt-12 pb-8 border-t border-gray-800">
      ...
      <div class="grid md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          <div class="flex items-center space-x-2 mb-6">
            ...
            <span class="text-2xl font-bold text-white">Social<span class="text-blue-400">Connect</span></span>
          </div>
          <p class="text-gray-400 mb-6">
            Building the future of web development with powerful tools and components.
          </p>
          <div class="flex space-x-4">
            ...
            <a href="#" class="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-500 transition">
              <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div class="flex">
            <input 
              ...
              class="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-l-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500"
            >
            <button class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-r-lg font-medium hover:opacity-90 transition">
              Subscribe
            </button>
          </div>
        </div>
